...
return [
    ...
    'Download.GetAll' => [[], ['_controller' => 'App\\Controller\\DowloadFilesController::GetAllImage'], [], [['text', '/api/filesAll']], [], [], []],
    ...
    'app_piece_modele_get_one' => [['modeleId', 'pieceId'], ['_controller' => 'App\\Controller\\PieceModeleController::getOne'], [], [['variable', '/', '[^/]++', 'pieceId', true], ['variable', '/', '[^/]++', 'modeleId', true], ['text', '/api/PieceEtModele']], [], [], []],
    'app_modele_piece_post' => [[], ['_controller' => 'App\\Controller\\PieceModeleController::createPieceModel'], [], [['text', '/api/PieceEtModele']], [], [], []],
    'app_modele_piece_delete' => [[], ['_controller' => 'App\\Controller\\PieceModeleController::delete'], [], [['text', '/api/PieceEtModele']], [], [], []],
    ...
    'App\Controller\DowloadFilesController::GetAllImage' => [[], ['_controller' => 'App\\Controller\\DowloadFilesController::GetAllImage'], [], [['text', '/api/filesAll']], [], [], []],
    ...
    'App\Controller\PieceModeleController::getOne' => [['modeleId', 'pieceId'], ['_controller' => 'App\\Controller\\PieceModeleController::getOne'], [], [['variable', '/', '[^/]++', 'pieceId', true], ['variable', '/', '[^/]++', 'modeleId', true], ['text', '/api/PieceEtModele']], [], [], []],
    'App\Controller\PieceModeleController::createPieceModel' => [[], ['_controller' => 'App\\Controller\\PieceModeleController::createPieceModel'], [], [['text', '/api/PieceEtModele']], [], [], []],
    'App\Controller\PieceModeleController::delete' => [[], ['_controller' => 'App\\Controller\\PieceModeleController::delete'], [], [['text', '/api/PieceEtModele']], [], [], []],
